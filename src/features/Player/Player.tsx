        ...
        <div className={cnBar('player-block')}>
          <div className={cnBar('player', 'player')}>
              <div className={cnPlayer('controls')}>
                  <div className={cnPlayer('btn-prev')}>
                    ...
                    {/* <img className={cnPlayer('btn-prev-svg')} alt="prev" src={iconPrev} /> */}
                  </div>
                  <div className={cnPlayer('btn-play', '_btn')}>
                    <svg className={cnPlayer('btn-play-svg')} width="15" height="20" viewBox="0 0 15 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M15 10L-1.01012e-06 0.47372L-1.84293e-06 19.5263L15 10Z" fill="#D9D9D9"/>
                    </svg>

                    {/* <img className={cnPlayer('btn-play-svg')} alt="play" src={iconPlay} /> */}
                  </div>
                  <div className={cnPlayer('btn-next')}>
                  ...
                  <div className={cnPlayer('btn-repeat', '_btn-icon')}>
                  ...
                  <div className={cnPlayer('btn-shuffle', '_btn-icon')}>
                  <svg className={cnPlayer('btn-shuffle-svg')} width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* <img className={cnPlayer('btn-shuffle-svg')} alt="shuffle" src={iconShuffle} /> */}
                  </div>
              </div>
              ...
              <div className={cnPlayer('track-play', 'track-play')}>
                <div className={cnTrackPlay('contain')}>
                  <div className={cnTrackPlay('image')}>
                    ...
                    {/* <img className={cnTrackPlay('svg')} alt="music" src={iconNote} /> */}
                  </div>
                  <div className={cnTrackPlay('author')}>
                    <a className={cnTrackPlay('author-link')} href="http://">Ты та...</a>
                  </div>
                  <div className={cnTrackPlay('album')}>
                    <a className={cnTrackPlay('album-link')} href="http://">Баста</a>
                  </div>
                </div>

                <div className={cnTrackPlay('like-dis')}>
                  <div className={cnTrackPlay('like', '_btn-icon')}>
                    <svg className={cnTrackPlay('like-svg')} width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#696969">
                      ...
                      {/* <img className={cnTrackPlay('like-svg')} alt="like" src={iconLike} /> */}
                  </div>
                  <div className={cnTrackPlay('dislike', '_btn-icon')}>
                    <svg className={cnTrackPlay('dislike-svg')} width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#696969">
                      <path d="M1 1L15 13.5"/>
                    ...
                    {/* <img className={cnTrackPlay('dislike-svg')} alt="dislike" src={iconDislike} /> */}
                  </div>
                </div>
              </div>
          </div>
          <div className={cnBar('volume-block', 'volume')}>
            <div className={cnBar('volume__content')}>
              <div className={cnBar('volume__image')}>
              <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M11 13C12.1046 13 13 11.2091 13 9C13 6.79086 12.1046 5 11 5" stroke="white"/>
              </svg>

                {/* <img className={cnBar('volume__svg')} alt="volume" src={iconVolume} /> */}
              </div>
              <div className={cnBar('volume__progress', '_btn')}>
                <input className={cnBar('volume__progress-line', '_btn')} type="range" name="range" />
              </div>
